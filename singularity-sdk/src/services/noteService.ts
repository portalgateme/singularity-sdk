...
export async function getNoteOnChainStatusByPublicKey(darkPool: DarkPool, note: Note, publicKey: any): Promise<NoteOnChainStatus> {
...
export async function getNoteOnChainStatusBySignature(darkPool: DarkPool, note: Note, signature: string): Promise<NoteOnChainStatus> {
