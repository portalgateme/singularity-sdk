import {
  NftNote,
  PartialNote,
  UniswapCollectFeesProofResult,
  createPartialNote,
  generateUniswapCollectFeeProof,
...
export class UniswapCollectFeeService extends BaseRelayerService<
  UniswapCollectFeesContext,
  UniswapCollectFeesRelayerRequest,
  MultiNotesResult
> {
  ...
  public async prepare(
    request: UniswapCollectFeesRequest,
    signature: string
  ): Promise<{ context: UniswapCollectFeesContext; outPartialNotes: PartialNote[] }> {
