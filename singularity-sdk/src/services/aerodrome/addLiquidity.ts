...
export class AerodromeAddLiquidityService extends BaseRelayerService<AerodromeAddLiquidityContext, AerodromeAddLiquidityRelayerRequest, MultiNotesResult> {
    ...
    protected async getRelayerRequest(context: AerodromeAddLiquidityContext): Promise<AerodromeAddLiquidityRelayerRequest> {
        if (!context
            || !context.request
            || !context.outLpTokenPartialNote
            || !context.outPartialChangeNote1
